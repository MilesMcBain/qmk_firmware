...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[L_BASE] = LAYOUT_split_3x6_3(KC_NO, KC_Q, KC_P, KC_Y, KC_C, KC_B,                          KC_V, KC_M, KC_U, KC_Z, KC_L, KC_NO, 
                                 KC_TAB, LGUI_T(KC_A), LALT_T(KC_N), LSFT_T(KC_I), LCTL_T(KC_S),KC_F, KC_D, RCTL_T(KC_T), RSFT_T(KC_H), LALT_T(KC_O), RGUI_T(KC_R), KC_QUOT, 
                                 KC_NO, KC_COMM, KC_DOT, KC_J, KC_G, KC_SCLN,                   KC_SLSH, KC_W, KC_K, KC_MINS, KC_X, KC_NO, 
	...
	[L_NAV] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                      KC_GRV, KC_1, KC_2, KC_3, KC_NO, KC_NO,
                                 KC_TAB, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NO,             KC_H, KC_J, KC_K, KC_L, KC_TAB, KC_NO, 
	...
	[L_NUM] = LAYOUT_split_3x6_3(KC_NO, KC_LBRC, KC_7, KC_8, KC_9, KC_RBRC,                     KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
                                 KC_NO, KC_SCLN, KC_4, KC_5, KC_6, KC_EQL,                      KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_RGUI, KC_NO, 
	...
	[L_SYM] = LAYOUT_split_3x6_3(KC_NO, KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR,            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
                                 KC_NO, KC_COLN, KC_DLR, KC_PERC, KC_CIRC, KC_PLUS,             KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_RGUI, KC_NO,
	...
	[L_FUN] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                      KC_PSCR, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, 
                                 KC_NO, KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NO,              KC_SLCK, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, 
